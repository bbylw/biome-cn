---
title: 规则来源
description: 将来自其他来源的 Lint 规则映射到 Biome 的页面
anchors: ["biome-exclusive-rules","rules-from-other-sources","mysticateaeslint-plugin","nexteslint-plugin-next","clippy","eslint","graphql-eslint","stylelint","eslint-plugin-barrel-files","eslint-plugin-import","eslint-plugin-jest","eslint-plugin-jsx-a11y","eslint-plugin-n","eslint-plugin-no-secrets","eslint-plugin-react","eslint-plugin-react-hooks","eslint-plugin-react-refresh","eslint-plugin-solid","eslint-plugin-sonarjs","eslint-plugin-stylistic","eslint-plugin-unicorn","eslint-plugin-unused-imports","typescript-eslint"]
toc: [{"level":2,"text":"Biome 专属规则","id":"biome-exclusive-rules"},{"level":2,"text":"来自其他来源的规则","id":"rules-from-other-sources"},{"level":3,"text":"@mysticatea/eslint-plugin","id":"mysticateaeslint-plugin"},{"level":3,"text":"@next/eslint-plugin-next","id":"nexteslint-plugin-next"},{"level":3,"text":"Clippy","id":"clippy"},{"level":3,"text":"ESLint","id":"eslint"},{"level":3,"text":"GraphQL-ESLint","id":"graphql-eslint"},{"level":3,"text":"Stylelint","id":"stylelint"},{"level":3,"text":"eslint-plugin-barrel-files","id":"eslint-plugin-barrel-files"},{"level":3,"text":"eslint-plugin-import","id":"eslint-plugin-import"},{"level":3,"text":"eslint-plugin-jest","id":"eslint-plugin-jest"},{"level":3,"text":"eslint-plugin-jsx-a11y","id":"eslint-plugin-jsx-a11y"},{"level":3,"text":"eslint-plugin-n","id":"eslint-plugin-n"},{"level":3,"text":"eslint-plugin-no-secrets","id":"eslint-plugin-no-secrets"},{"level":3,"text":"eslint-plugin-react","id":"eslint-plugin-react"},{"level":3,"text":"eslint-plugin-react-hooks","id":"eslint-plugin-react-hooks"},{"level":3,"text":"eslint-plugin-react-refresh","id":"eslint-plugin-react-refresh"},{"level":3,"text":"eslint-plugin-solid","id":"eslint-plugin-solid"},{"level":3,"text":"eslint-plugin-sonarjs","id":"eslint-plugin-sonarjs"},{"level":3,"text":"eslint-plugin-stylistic","id":"eslint-plugin-stylistic"},{"level":3,"text":"eslint-plugin-unicorn","id":"eslint-plugin-unicorn"},{"level":3,"text":"eslint-plugin-unused-imports","id":"eslint-plugin-unused-imports"},{"level":3,"text":"typescript-eslint","id":"typescript-eslint"}]
---
...
| @next/eslint-plugin-next 规则名 | Biome 规则名 |
| ---- | ---- |
...
| eslint-plugin-jsx-a11y 规则名 | Biome 规则名 |
| ---- | ---- |
...
| eslint-plugin-unicorn 规则名 | Biome 规则名 |
| ---- | ---- |
...
### typescript-eslint
| typescript-eslint 规则名 | Biome 规则名 |
| ---- | ---- |
